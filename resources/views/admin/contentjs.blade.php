                    ...
                    if (data.MAIN_HOLE_READY_UNIT != null) {
                      ...
                      $('#main_hole_unit_2_GEDUNG').prop('checked', true);
                        ...
                        if (data.SUBMIT_PROPOSAL_DATE == "01-01-1970" ||data.SUBMIT_PROPOSAL_DATE == null) {
                          // alert("sadasdad");
                          $('#SUBMIT_PROPOSAL_DATE_HALO').val(moment().format('D-MM-YYYY'));
                          }else{
              ...
              console.log(next);
                ...
                $.ajax({
                    ...
                    success: function(data) {
                      ...
                      $('#FREE_SERVICE_1_1_1').val(FREE_SERVICES[0]);
...
"searching": false,
    ...
    @endif
        ...
        // table.page(6).draw(false);
        // console.log(info);
    // var info = table.page.info();
    // console.log(info);
    // table.page.len( 10 ).draw();
    @if (Request::is('revshare'))
      @else
