...
<div class="col-md-12">
    ...
    <div class="card card-outline card-primary">
        <div class="card-header">MY PROGRESS <a href="{{Route('ExportReport',"Ready_To_sell")}}"
            ...
            <table class="table table-bordered" id="users-table" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="building_name" class="text-center">{{$data->BUILDING_NAME}}</td>
                        <td class="text-center">{{$data->PROGRESS_STATUS}}</td>
                        <td class="text-center">{{$data->PKS_DATE}}</td>
                        <td class="text-center">{{$data->BASO_DATE}}</td>
                        <td class="text-center">{{$data->HP_PORT}}</td>
                        <td class="text-center">{{ $data->EXCLUSIVE === "YES" ? "EXCLUSIVE" : "NOT EXCLUSIVE" }}</td>
                        <td class="text-center">{{ $data->Tingkat_Okupansi_PNL }}</td>
                        <td class="text-center">{{ $data->Occp_Based }}</td>
                        <td class="text-center">{{ $data->Total_Revenue }}</td>
                        <td class="text-center">{{ $data->Revenue_Share_persen }}</td>
                        <td class="text-center">{{ $data->Revenue_Share_rp }}</td>
                        <td class="text-center">{{ $data->Biaya_Sewa }}</td>
                        <td class="text-center">{{ $data->ONE_TIME_FEE }}</td>
                        <td class="text-center">{{ $data->total_biaya }}</td>
                        <td class="text-center">{{ $data->Investasi }}</td>
                        <td class="text-center">{{ $data->cpe_cost }}</td>
                        <td class="text-center">{{ $data->COGS }}</td>
                        <td class="text-center">{{ $data->margin_by_total_duration }}</td>
                        <td class="text-center">{{ $data->margin_persen }}</td>
                        <td class="text-center">{{ $data->breakeven_point }}</td>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select name="PROGRESS_STATUS" class="form-control">
                                    ...
                                    <option value="NEGOTIATION 1 - BUSINESS SCHEME">NEGOTIATION 1 - BUSINESS
                                        SCHEME</option>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <select name="status_kerjasama_pnl" class="form-control" id="status_kerjasama_pnl">
                            <option value="YES" id="Exclusive">Exclusive</option>
