<div class="col-md-12">
    <div class="card card-outline card-primary">
        ...
        <div class="card-body">
            ...
            @elsemobile
            <h4 style="position: absolute;margin-top:5px;">Total Potensial Homepass : <b>{{$total_hp}}</b> </h4>
            @endmobile
            <div>
                                        ...
                                        <p class="container">
                                            ...
                                            <div class="row  mt-3 mr-2">
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <div class="icheck-primary d-inline ml-3">
                                                            <input type="radio" id="On_Progres_new"
                                                                name="status_bangunan" value="On_Progres" />
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                            ...
                            <form method="POST" action="{{Route('update')}}" name="Edit_REPORT_DESK_SURVEY"
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select onchange="fase(this);" name="PROGRESS_STATUS" id="PROGRESS_STATUS"
                                                ...
                                                <option value="SITE SURVEY" disabled>SITE SURVEY</option>
                                                <option value="BOQ, SITE SURVEY REPORT, DESIGN" disabled>BOQ, SITE
                                                    SURVEY
                                                    REPORT, DESIGN
                                                </option>
                                                <option value="PnL PROGRESS" disabled>PnL PROGRESS</option>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label>PROPERTY TYPE</label>
                                            <select onchange="property_type(this)" name="PROPERTY_TYPE"
                                    ...
                                    <div class="col-sm-6">
                                        <label>Launch DD/MM/YY</label>
                                        <input type="text" name="launch_data" id="launch_data_edit"
                                            data-toggle="datepicker" class="form-control" id="">
                                    </div>
                                            ...
                                            <div class="border ">
                                                <div class="row  mt-3 mr-2">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            <div class="icheck-primary d-inline ml-3">
                                                                <input type="radio" id="On_Progres"
                                                                    name="status_bagunan" value="On_Progres" />
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea placeholder="Masukan UPDATE PROGRESS" name="UPDATE_PROGRESS_DESK"
                                                id="UPDATE_PROGRESS_DESK" cols="30" rows="10"
                                ...
                                <div class=" row mt-2">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select onchange="fase(this);" name="PROGRESS_STATUS"
                                                ...
                                                <option value="NEGOTIATION 1 - BUSINESS SCHEME"><a
                                                        href="submit">NEGOTIATION
                                                        1 -
                                                        BUSINESS SCHEME</a>
                                                </option>
                                                <option value="SITE SURVEY" disabled>SITE SURVEY</option>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="DEVELOPERORCOMPANY_NAME"
                                                id="DEVELOPERORCOMPANY_NAME" class="form-control"
                                                placeholder="Masukan Developer Name" />
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="PHONEORMOBILE" id="PHONEORMOBILE"
                                                class="form-control" placeholder="Masukan Office Phone" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group clearfix">
                                                <input type="text" data-toggle="datepicker" name="SUBMIT_PROPOSAL_DATE"
                                                    id="SUBMIT_PROPOSAL_DATE_HALO" class="form-control"
                                                    name="busdev_ date" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4" id="rata_rata_gedung">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group clearfix">
                                                <input type="text" class="form-control" name="rata_rata"
                                                    id="rata-rata" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6" id="membantu_gedung">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group clearfix">
                                                <div class="icheck-primary d-inline">
                                                    <input type="radio" id="membantu_1" value="YES" name="membantu"
                                                        checked />
                                    ...
                                    <div class="col-sm-3" id="re_wiring_apartemen">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group clearfix">
                                                <div class="icheck-primary d-inline">
                                                    <input type="radio" id="rewiring1" value="YES" name="rewiring"
                                                        checked />
                                    ...
                                    <div class="col-sm-6" id="perapihan_apartemen">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group clearfix">
                                                <div class="icheck-primary d-inline">
                                                    <input type="radio" id="perapihan_1" value="YES" name="perapihan"
                                                        checked />
                                    ...
                                    <div class="container mt-3 mb-3" id="tower_apartemen">
                                        <table class="table-input">
                                            <tr>
                                                <td style="background-color:#0679FB"><b class="text-white">Tower</b>
                                                </td>
                                                ...
                                                <td style="background-color:#0679FB"><b class="text-white">Total</b>
                                                </td>
                                            </tr>
                                            <tr id="jumlah_lantai_tower">
                                                <td class="text-left pl-3">Jumlah Lantai</td>
                                                <td><input type="text" size="3" class="jumlah_lantai"
                                            ...
                                            <tr id="jumlah_unit_tower">
                                                ...
                                                <td><input type="text" size="3" class="jumlah_unit" name="jumlah_unit_9"
                                                        id="jumlah_unit_9" /></td>
                                                <td><input type="text" size="3" class="jumlah_unit"
                                                        name="jumlah_unit_10" id="jumlah_unit_10" />
                                                </td>
                                                <td><input type="text" size="6" name="jumlah_unit_total" readonly />
                                                </td>
                                            </tr>
                                            ...
                                            <tr id="jumlah_tingkat_okupansi_tower">
                                                ...
                                                <td><input type="text" size="3" class="tingkat_okupansi"
                                                        name="tingkat_okupansi_1" id="tingkat_okupansi_1" readonly />
                                                </td>
                                                <td><input type="text" size="3" class="tingkat_okupansi"
                                                ...
                                                <td><input type="text" size="6" name="tingkat_okupansi_total"
                                                        readonly />
                                                </td>
                                            </tr>
                                            <tr id="jumlah_unit_area_komersial_tower">
                                                ...
                                                <td><input type="text" size="3" class="jumlah_unit_area_kemerial"
                                                        ...
                                                        id="jumlah_unit_area_kemerial_1" />
                                                </td>
                                                <td><input type="text" size="3" class="jumlah_unit_area_kemerial"
                                                        name="jumlah_unit_area_kemerial_2"
                                                        id="jumlah_unit_area_kemerial_2" />
                                                </td>
                                                <td><input type="text" size="3" class="jumlah_unit_area_kemerial"
                                                        name="jumlah_unit_area_kemerial_3"
                                                        id="jumlah_unit_area_kemerial_3" />
                                                </td>
                                                <td><input type="text" size="3" class="jumlah_unit_area_kemerial"
                                                        name="jumlah_unit_area_kemerial_4"
                                                        id="jumlah_unit_area_kemerial_4" />
                                                </td>
                                                <td><input type="text" size="3" class="jumlah_unit_area_kemerial"
                                                        name="jumlah_unit_area_kemerial_5"
                                                        id="jumlah_unit_area_kemerial_5" />
                                                </td>
                                                <td><input type="text" size="3" class="jumlah_unit_area_kemerial"
                                                        name="jumlah_unit_area_kemerial_6"
                                                        id="jumlah_unit_area_kemerial_6" />
                                                </td>
                                                <td><input type="text" size="3" class="jumlah_unit_area_kemerial"
                                                        name="jumlah_unit_area_kemerial_7"
                                                        id="jumlah_unit_area_kemerial_7" />
                                                </td>
                                                <td><input type="text" size="3" class="jumlah_unit_area_kemerial"
                                                        name="jumlah_unit_area_kemerial_8"
                                                        id="jumlah_unit_area_kemerial_8" />
                                                </td>
                                                <td><input type="text" size="3" class="jumlah_unit_area_kemerial"
                                                        name="jumlah_unit_area_kemerial_9"
                                                        id="jumlah_unit_area_kemerial_9" />
                                                </td>
                                                <td><input type="text" size="3" class="jumlah_unit_area_kemerial"
                                                        name="jumlah_unit_area_kemerial_10"
                                                        id="jumlah_unit_area_kemerial_10" />
                                                </td>
                                            ...
                                            <tr id="tingkat_okupansi_2">
                                                ...
                                                <td><input type="text" size="6"
                                                        name="jumlah_tingkat_okupansi_area_total" readonly />
                                                </td>
                                            </tr>
                                            <tr id="jumlah_kendaraan_terdaftar">
                                                ...
                                                <td><input type="text" size="3" class="jumlah_kendaraan_terdaftar"
                                                        ...
                                                        id="jumlah_kendaraan_terdaftar_1" />
                                                </td>
                                                <td><input type="text" size="3" class="jumlah_kendaraan_terdaftar"
                                                ...
                                                <div class="row ml-2 ">
                                                    ...
                                                    <div class="float-right ml-2 mt-3">
                                                        <input type="number" class="type_unit form-control"
                                                            name="type_unit_studio" id="type_unit_studio"
                                                            class="form-control"
                                                    ...
                                                    <div class="float-right ml-2 mt-3">
                                                        <input type="number" class="type_unit form-control"
                                                            name="type_unit_1br" id="type_unit_1br" class="form-control"
                                                            style="width:70px; margin-top:-7px; margin-bottom:10px">
                                                    </div>
                                                    <div class="float-right ml-2 mt-3">
                                                        2 BR
                                                    ...
                                                    <div class="float-right ml-2 mt-3">
                                                        <input type="number" class="type_unit form-control"
                                                            name="type_unit_2br" id="type_unit_2br" class="form-control"
                                                            style="width:70px; margin-top:-7px; margin-bottom:10px">
                                                    </div>
                                                    <div class="float-right ml-2 mt-3">
                                                        3 BR
                                                    ...
                                                    <div class="float-right ml-2 mt-3">
                                                        <input type="number" class="type_unit form-control"
                                                            name="type_unit_3br" id="type_unit_3br" class="form-control"
                                                            style="width:70px; margin-top:-7px; margin-bottom:10px">
                                                    </div>
                                                    <div class="float-right ml-2 mt-3">
                                                        Penthouse
                                                    ...
                                                    <div id="error_total_unit">
                                                        <i
                                                            class=" fa-2x fas fa-exclamation-triangle ml-4 mt-3 text-danger mr-2"></i>
                                                        <p class="text-danger  mt-2 float-right ml-2"> Total yang di
                                                            masukan
                                                            <br>
                                                            lebih dari
                                                            Jumlah
                                            ...
                                            <div class="border ">
                                                <div class="row   ml-2 mr-2">
                                                    ...
                                                    <div class="col-md-3 mt-3"
                                                        style="margin-top:-7px; margin-bottom:9px">
                                                        <input type="text" name="terendah" id="terendah"
                                                    ...
                                                    <div class="float-right mt-3"
                                                        style="margin-top:-7px; margin-bottom:9px">
                                                        <input type="text" name="tertingi" id="tertingi"
                                                            style="width:160px" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row  ml-2">
                                                    ...
                                                    <div class="col-sm-2  mt-3 ml-2 "
                                                        ...
                                                        <div class="form-group mb-2">
                                                            <div class="icheck-primary d-inline">
                                                                <input type="checkbox" id="Coaxial_building"
                                                                    value="Coaxial" name="Infrastruktur_Coaxial" />
                                                    ...
                                                    <div class="col-sm-2  mt-3 "
                                                        ...
                                                        <div id="Infrastruktur_apartemen"
                                                            class="switch-field mt-4 ml-3">
                                                            <input type="radio" id="FTTH_radio1" name="FTTH_radio"
                                                                value="BM" checked />
                                                    ...
                                                    <div class="col-sm-2  mt-3 "
                                                        ...
                                                        <div id="Infrastruktur_apartemen"
                                                            class="switch-field mt-4 ml-3">
                                                            <input type="radio" id="ADSL_radio1" name="ADSL_radio"
                                                                value="BM" checked />
                                                    ...
                                                    <div class="col-sm-2  mt-3 "
                                                        ...
                                                        <div id="Infrastruktur_apartemen"
                                                            class="switch-field mt-4 ml-3">
                                                            <input type="radio" id="UTP_radio1" name="UTP_radio"
                                                                value="BM" checked />
                                            ...
                                            <div class="border ">
                                                <div class="row  ml-2 ">
                                                    ...
                                                    <div class="float-right mt-3 " style="padding-left:0px;">
                                                        <div class="form-group clearfix">
                                                            <div class="icheck-primary d-inline">
                                                                <input type="radio" id="main_hole_koridor_YES"
                                                                    value="YES" name="main_hole_koridor" checked />
                                            ...
                                            <div class="border ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3 mt-3" style="margin-left:0px;">
                                                        <div class="form-group">
                                                            <div class="icheck-primary d-inline ml-3">
                                                                <input type="checkbox" id="Control_Room"
                                                                    value="Control_Room" name="Control_Room" />
                                                    ...
                                                    <div class="col-sm-3 mt-3">
                                                        <div class="form-group">
                                                            <div class="icheck-primary d-inline ml-3">
                                                                <input type="checkbox" id="Shaft" value="Shaft"
                                                                    name="Shaft" />
                                            ...
                                            <div class="border ">
                                                <div class="row  mt-3">
                                                    ...
                                                    <div class="col-sm-3" style="margin-left:0px;">
                                                        <div class="form-group">
                                                            <div class="icheck-primary d-inline ml-3">
                                                                <input type="checkbox" id="ODP" value="ODP"
                                                                    name="ODP" />
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            <div class="icheck-primary d-inline ml-3">
                                                                <input type="checkbox" id="unit" value="unit"
                                                                    name="unit" />
                                            ...
                                            <div class="border ">
                                                <div class="row  ">
                                                    ...
                                                    <div class="col-md-2 mt-3 ml-3">
                                                        <div class="form-group clearfix">
                                                            <div class="icheck-primary d-inline">
                                                                <input type="radio" id="biaya_1" value="YES"
                                                                    name="biaya" checked />
                                                                <label for="biaya_1">YES</label>
                                                            </div>
                                                            <div class="icheck-primary d-inline ml-2">
                                                                <input type="radio" id="biaya_2" value="NO"
                                                                    name="biaya" />
                                            ...
                                            <div class="border ">
                                                <div class="row ">
                                                    ...
                                                    <div class="col-sm-2 mt-3">
                                                        <div class="form-group">
                                                            <div class="icheck-primary d-inline ml-3">
                                                                <input type="checkbox" id="IPTV" value="IPTV"
                                                                    name="IPTV" />
                                            ...
                                            <div class="border ">
                                                <div class="row ">
                                                    ...
                                                    <div class="col-sm-2 mt-4">
                                                        <div class="input-group ">
                                                            <input type="number" class="form-control"
                                                                placeholder="Masukan Mahasiswa" name="Weekday"
                                                                id="Weekday" />
                                                    ...
                                                    <div class="col-sm-2 mt-4">
                                                        <div class="input-group ">
                                                            <input type="number" class="form-control"
                                                                placeholder="Masukan Mahasiswa" name="Weekend"
                                                                id="Weekend" />
                                                            <div class="input-group-append">
                                                                <span class="input-group-text">%</span>
                                                            </div>
                                                    ...
                                                    <div class="col-sm-2 mt-4">
                                                        <div class="input-group ">
                                                            <input type="number" class="form-control"
                                                                placeholder="Masukan Mahasiswa" name="minggu"
                                                                id="minggu" />
                                                            <div class="input-group-append">
                                                                <span class="input-group-text">%</span>
                                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="border mt-2" id="jenis_pekerjaan_apartemen">
                                                ...
                                                <div class="row  mt-3">
                                                    ...
                                                    <div class="col-md-1  mt-2"
                                                        style="margin-right:20px;padding-left:0px;">
                                                        <b>Karyawan</b>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <div class="input-group mb-3" style="width: 105px;">
                                            ...
                                            <div class="border mt-2" id="status_penghuni">
                                                ...
                                                <div class="row  mt-3">
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="input-group mb-3" style="width: 105px;">
                                                            <input type="number" name="single" id="single"
                                                                class="form-control" placeholder="Masukan single" />
                                                            <div class="input-group-append">
                                                                <span class="input-group-text">%</span>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-1 ml-1 mt-2" id="45ketas_text"><b>Usia > 45
                                                            Thn</b>
                                                    </div>
                                                    <div class="col-md-4" id="45keatas_input">
                                                        <div class="input-group mb-3" style="width: 105px;">
                                                            <input type="number" name="empatlimakeatas"
                                                                id="empatlimakeatas" class="form-control"
                                                                placeholder="Masukan keluarga" />
                                                            <div class="input-group-append">
                                                                <span class="input-group-text">%</span>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row ml-2 mr-2 mt-3">
                                                    ...
                                                    <div class="col-md-3">
                                                        <input type="number" name="Distributor" id="Distributor"
                                                            class="form-control">
                                                        <input type="number" name="Resto" id="Resto"
                                                            class="form-control">
                                                        ...
                                                        <input type="number" name="Lembaga_Pendidikan"
                                                            id="Lembaga_Pendidikan" class="form-control">
                                    ...
                                    <div class="container mt-3 mb-3">
                                        <table class="provider">
                                            <tr>
                                                <td rowspan="2" class="bg-primary text-white" colspan="2">Provider
                                                    Existing
                                                </td>
                                                <td colspan="3" class="bg-primary text-white">Berikan tanda cek list
                                                </td>
                                                <td colspan="2" class="bg-primary text-white">Eksklusif</td>
                                                <td rowspan="2" class="bg-primary text-white">Durasi Kerjasama s/d.
                                                    Bln/thn
                                                </td>
                                            ...
                                            <tr>
                                                <td width="20px">1</td>
                                                <td><input type="text" size="3" name="Provider_1" id="Provider_1" />
                                                </td>
                                                ...
                                                <td><input type="text" size="3" name="Sewa_Lahan_1" id="Sewa_Lahan_1" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="20px">2</td>
                                                <td><input type="text" size="3" name="Provider_2" id="Provider_2" />
                                                </td>
                                                ...
                                                <td><input type="text" size="3" name="Sewa_Lahan_2" id="Sewa_Lahan_2" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="20px">3</td>
                                                <td><input type="text" size="3" name="Provider_3" id="Provider_3" />
                                                </td>
                                                ...
                                                <td><input type="text" size="3" name="Sewa_Lahan_3" id="Sewa_Lahan_3" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="20px">4</td>
                                                <td><input type="text" size="3" name="Provider_4" id="Provider_4" />
                                                </td>
                                                ...
                                                <td><input type="text" size="3" name="Sewa_Lahan_4" id="Sewa_Lahan_4" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="20px">5</td>
                                                <td><input type="text" size="3" name="Provider_5" id="Provider_5" />
                                                </td>
                                                ...
                                                <td><input type="text" size="3" name="Sewa_Lahan_5" id="Sewa_Lahan_5" />
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                                    ...
                                    <div class="container mt-3 mb-3 ">
                                        <table class="marketing">
                                            <tr>
                                                <td class="text-left bg-primary text-white"
                                                ...
                                                <td class="bg-primary text-white" style="width: 100px;">Pintu parkir
                                                    in/out
                                                </td>
                                                ...
                                                <td class="bg-primary text-white" style="padding:10px;">Receptionist
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="checkbox" value="aktifitas_basemant"
                                                        id="aktifitas_basemant" name="aktifitas_basemant"></td>
                                                ...
                                                <td><input type="checkbox" value="aktifitas_swmg_pool"
                                                        id="aktifitas_swmg_pool" name="aktifitas_swmg_pool"></td>
                                                <td><input type="checkbox" value="aktifitas_fitness"
                                                        id="aktifitas_fitness" name="aktifitas_fitness"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="checkbox" value="POP_UP_TABLE_lobby"
                                                        id="POP_UP_TABLE_lobby" name="POP_UP_TABLE_lobby">
                                                </td>
                                                ...
                                                <td><input type="checkbox" value="POP_UP_TABLE_mgmt_office"
                                                        id="POP_UP_TABLE_mgmt_office" name="POP_UP_TABLE_mgmt_office">
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="checkbox" value="penempatan_standuk_basemant"
                                                        ...
                                                        name="penempatan_standuk_basemant">
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="checkbox" value="Penempatan_Poster_basemant"
                                                        ...
                                                        name="Penempatan_Poster_basemant">
                                                </td>
                                                ...
                                                <td><input type="checkbox" value="Penempatan_Poster_swmg_pool"
                                                        ...
                                                        name="Penempatan_Poster_swmg_pool">
                                                </td>
                                                ...
                                                <td><input type="checkbox" value="Penempatan_Poster_mgmt_office"
                                                        ...
                                                        name="Penempatan_Poster_mgmt_office">
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="checkbox" value="sticker_basemant"
                                                        id="sticker_basemant" name="sticker_basemant"></td>
                                                ...
                                                <td><input type="checkbox" value="sticker_swmg_pool"
                                                        id="sticker_swmg_pool" name="sticker_swmg_pool"></td>
                                                ...
                                                <td><input type="checkbox" value="sticker_mgmt_office"
                                                        id="sticker_mgmt_office" name="sticker_mgmt_office"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="checkbox" value="roll_up_basemant"
                                                        id="roll_up_basemant" name="roll_up_basemant"></td>
                                                ...
                                                <td><input type="checkbox" value="roll_up_swmg_pool"
                                                        id="roll_up_swmg_pool" name="roll_up_swmg_pool"></td>
                                                ...
                                                <td><input type="checkbox" value="roll_up_mgmt_office"
                                                        id="roll_up_mgmt_office" name="roll_up_mgmt_office"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="checkbox" value="acrilic_basemant"
                                                        id="acrilic_basemant" name="acrilic_basemant"></td>
                                                ...
                                                <td><input type="checkbox" value="acrilic_swmg_pool"
                                                        id="acrilic_swmg_pool" name="acrilic_swmg_pool"></td>
                                                ...
                                                <td><input type="checkbox" value="acrilic_mgmt_office"
                                                        id="acrilic_mgmt_office" name="acrilic_mgmt_office"></td>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea placeholder="Masukan UPDATE PROGRESS" name="UPDATE_PROGRESS"
                                                id="UPDATE_PROGRESS" cols="30" rows="10"
                                                class="form-control"></textarea>
                                            <div class="col-sm-6 mt-4">
                                                <button type="submit " class="btn btn-primary"
                                                    style="width:100px;">Save</button>
                                ...
                                <div class=" row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="ONE_TIME_FEE" id="ONE_TIME_FEE"
                                                class="form-control" placeholder="Masukan ONE TIME FEE" />
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                        ...
                                        <div class="border w-100">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input type="text" class="form-control" style="width:50px;"
                                                            name="FREE_SERVICE_1" id="FREE_SERVICE_1_1">
                                                        <label class="form-check-label" for="inlineCheckbox1">
                                                            &nbsp&nbspLayanan</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <select class="form-control" name="FREE_SERVICE_2"
                                                            id="FREE_SERVICE_2">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <select name="FREE_SERVICE_4" id="FREE_SERVICE_4"
                                                            class="form-control">
                                                            <option value="Entertainment" selected>Entertainment
                                                            </option>
                                                            <option value="Lifestyle - Licious">Lifestyle - Licious
                                                            </option>
                                                            ...
                                                            <option value="Asian Movies Lover">Asian Movies Lover
                                                            </option>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <select class="form-control" name="FREE_SERVICE_6"
                                                            id="FREE_SERVICE_6">
                                                            <option value="10 Mbps">10</option>
                                                            <option value="15 Mbps">15</option>
                                                            <option value="20 Mbps">20</option>
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <select name="FREE_SERVICE_8" id="FREE_SERVICE_8"
                                                            class="form-control">
                                    ...
                                    <div class="col-sm-12 mt-2">
                                        <div class="form-group">
                                            <label>UPDATE PROGRESS</label>
                                            <textarea placeholder="Masukan UPDATE PROGRESS"
                                                name="UPDATE_PROGRESS_NEGOTION_1" id="UPDATE_PROGRESS_NEGOTION_1"
                                ...
                                <div class="row mt-2 ml-2">
                                    <div class="col-sm-6 ">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group clearfix">
                                                <form action="{{Route('update.uploadFAFULL')}}"
                                                    name="UPLOAD_FA_FULL_PDF" id="UPLOAD_FA_FULL_PDF" method="post"
                                                    enctype="multipart/form-data">
                                                    <input type="hidden" id="id_SITE_SURVEY_PDF"
                                                        name="id_SITE_SURVEY_PDF">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" data-toggle="datepicker" name="SALES_SIGNED"
                                                id="SALES_SIGNED" class="form-control">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label>UPDATE PROGRESS</label>
                                            <textarea placeholder="Masukan UPDATE PROGRESS"
                                                name="UPDATE_PROGRESS_SITE_SURVEY" id="UPDATE_PROGRESS_SITE_SURVEY"
                                                cols="30" rows="10" class="form-control"></textarea>
                                        </div>
                                    </div>
                        ...
                        <div id="Edit_BOQ" class="ilang">
                                ...
                                <div class="row mt-2 ml-2 ">
                                    <div class="col-sm-6">
                                        <form action="{{Route('uploadBOQ_SITE_SURVEY')}}" id="site_survey_pdf"
                                            ...
                                            <input type="hidden" id="id_BOQ_PDF_SITE_SURVEY"
                                                name="id_BOQ_PDF_SITE_SURVEY">
                                            <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <form action="{{Route('uploadBOQ')}}" id="upload_boq_pdf" name="upload_boq_pdf"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="file" accept=".pdf" name="upload_boq_pdf"
                                                    id="upload_boq_pdf">
                                                <input type="submit" class="btn btn-primary btn-sm mt-3 w-25">
                                            </div>
                                        </form>
                                    ...
                                    <div class="col-sm-6">
                                        <form action="{{Route('uploadAPD')}}" id="upload_apd_pdf_FORM"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="file" accept=".pdf" name="upload_apd_pdf"
                                                    id="upload_apd_pdf_data">
                                                <input type="submit" class="btn btn-primary btn-sm mt-3 w-25">
                                            </div>
                                        </form>
                                    </div>
                            ...
                            <form method="POST" action="{{Route('update.boq')}}" name="Edit_BOQ" id="Edit_BOQ_FORM"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select onchange="fase(this);" name="PROGRESS_STATUS"
                                                ...
                                                <option value="SITE SURVEY" disabled>SITE SURVEY</option>
                                                <option value="BOQ, SITE SURVEY REPORT, DESIGN" selected>BOQ, SITE
                                                    SURVEY
                                                    REPORT, DESIGN
                                                </option>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea placeholder="Masukan UPDATE PROGRESS" name="UPDATE_PROGRESS_BOQ"
                                                id="UPDATE_PROGRESS_BOQ" cols="30" rows="10"
                                                class="form-control"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 mt-4">
                                ...
                                <div class="row mt-2 ml-2">
                                    <div class="col-sm-6 ">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group clearfix">
                                                <form action="{{Route('UploadPNL')}}" name="upload_pnl_pdf"
                                                    id="upload_pnl_pdf" method="post" enctype="multipart/form-data">
                    ...
                    <div class=" row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="PNL_DATE" data-toggle="datepicker" id="PNL_DATE"
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="tingkat_okupansi_pnl" id="tingkat_okupansi_pnl"
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-2">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" name="pnl_rev_share_persen" id="pnl_rev_share_persen"
                                    class="form-control">
                                <div class="input-group-append">
                                    <span class="input-group-text">%</span>
                                </div>
                            ...
                            <div class="border w-100">
                                <div class="col-sm-12 mt-2">
                                    <div class="form-group">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input type="text" class="form-control" style="width:50px;"
                                                name="FREE_SERVICE_1" id="FREE_SERVICE_1_1_PNL">
                                            <label class="form-check-label" for="inlineCheckbox1">
                                                &nbsp&nbspLayanan</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-check form-check-inline">
                                            <input type="text" class="form-control" style="width:50px;"
                                                name="FREE_SERVICE_5" id="FREE_SERVICE_5_PNL">
                                            <label class="form-check-label" for="inlineCheckbox1">
                                                &nbsp&nbspLayanan</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                    ...
                    <div class="row">
                        <div class="col-sm-3 mt-2 ml-2 ">
                            <div class="form-group">
                                ...
                                <div class="form-group clearfix">
                                    <form action="{{Route('update.updateBASO')}}" id="BASO_PDF" name="BASO_PDF"
                                        method="post" enctype="multipart/form-data">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body " style="height:500px;overflow-y: scroll;">
                <div class="text-center mt-5 mb-5">
                    ...
                    <h4 class="text-danger"> - {{$data->pesan}}</h4>
                    <br>
                    @endforeach
