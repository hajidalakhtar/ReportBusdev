        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                <ul class="nav nav-tabs" style="margin-bottom:-16px;" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#dashboard" role="tab"
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="contact-tab" data-toggle="tab" href="#messages" role="tab"
                            aria-controls="contact" aria-selected="false">Messages</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="chart-tab" data-toggle="tab" href="#chart" role="tab"
                            aria-controls="contact" aria-selected="false">Reject</a>
                    </li>
                </ul>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade show active" id="dashboard" role="tabpanel" aria-labelledby="contact-tab">
